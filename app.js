...
const realData = {
  ...
  coaches: [
    ...
    { name: "Devendra Mittal", role: "Fitness Trainer", slug: "mittal", category: "fitness", bio: "Fitness Trainer specializing in strength and conditioning.", focus: ["Fitness training", "Strength", "Conditioning"], highlight: "Strength & Conditioning", color: "red", image: "https://web.s-cdn.boostkit.dev/webaction-files/67dd161916df35677e31c42c_myteam/img_0291-69538ccf8c7b7b2c6178b6e1.jpg" },
    { name: "Shashi Mishra", role: "Fitness Trainer", slug: "shashi-mishra", category: "fitness", bio: "Fitness Trainer focused on overall wellness and strength.", focus: ["Fitness training", "Strength", "Wellness"], highlight: "Wellness Coach", color: "red", image: "https://web.s-cdn.boostkit.dev/webaction-files/67dd161916df35677e31c42c_myteam/img_0295-69538d35474cc000b54586b7.jpg" },
  ],
  testimonials: [
...
function getApiBase() {
  // Production Hostinger domain must use same-origin PHP — never an old tunnel/Render override.
  try {
    var host = String(location.hostname || "").toLowerCase();
    if (host === "fitnessgurukul.app" || host === "www.fitnessgurukul.app") {
      try { localStorage.removeItem("fg_api_base"); } catch (e0) {}
